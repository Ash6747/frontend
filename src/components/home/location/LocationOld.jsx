...
const point2 = [
    { icon: Location1, desc: "From EON IT Park & WTC" },
    { icon: Location2, desc: "From Nagar Highway" },
    { icon: Location3, desc: "Within Township" },
    { icon: Location4, desc: "To major healthcare centers" },
    { icon: Location5, desc: "Within Township" },
    { icon: Location6, desc: "To Pune International Airport" },
];
...
const LocationOld = () => {
    ...
    const mapImage = activeTab === "west" ? "/images/location/map1.webp" : "/images/location/map-1.webp";
    const currentPoints = activeTab === "west" ? point2 : points;
        ...
        <Suspense fallback={null}>
            <section id="location_wrapper" className="location-section section-space side-space">
                ...
                <div className="location-container">
                    <div className="title-wrapper mx-auto text-center" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
                        ...
                        <div className="amenities-tabs" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
